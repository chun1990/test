...
class AndroidTests(unittest.TestCase):
    ...
    def test_payCenter_page(self):
        ...
        self.driver.find_element_by_name('其他支付方式').click()
        time.sleep(2)
        #获取支付中心页面截图
        list=self.driver.find_elements_by_id('ppsgame_qudao_name_portrait')
    ...
    def payCenter_Alipayweb(self):
        ...
        self.driver.find_element_by_name('其他支付方式').click()
        time.sleep(2)
        self.swipe('ppsgame_qudao_name_portrait')
        time.sleep(1)
    ...
    def swipe(self,id):
        ids=self.driver.find_elements_by_id(id)
        origin_el =ids[-1]
        #定位元素要移动到的目标位置
